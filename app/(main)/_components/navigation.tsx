"use client";
import { ChevronsLeft, Search, Settings, Plus, Trash } from "lucide-react";
      ...
      >
        ...
        <div
          ...
          className="opacity-0 group-hover/sidebar:opacity-100 transition 
            cursor-ew-resize absolute h-full w-1 bg-primary/10 right-0 top-0 flex flex-col justify-center"
        ></div>
      </aside>
      <div
        ref={navbarRef}
